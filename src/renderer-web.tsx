...
import { WebIpcClient } from "./ipc/web_api_client";
...
// Create a global IpcClient alias that uses the web implementation
// This allows existing code to work without modification
(window as any).IpcClient = WebIpcClient;

console.log("Running Dyad Web App in mode:", import.meta.env.MODE);
...
function App() {
  ...
  useEffect(() => {
    const ipc = WebIpcClient.getInstance();
  ...
  // Forward telemetry events from backend to PostHog
  useEffect(() => {
    const ipc = WebIpcClient.getInstance();
